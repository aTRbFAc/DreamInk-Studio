    ...
    const modalHTML = `
        <div class="full-protocol-modal">
            <div class="full-modal-content">
                ...
                <div class="full-modal-subtitle">一、《用户协议》变更内容</div>

                <div class="full-modal-section-title">1. 新增合规条款模块</div>
                <ul class="full-modal-list">
                    <li>新增<strong>个人信息保护专条</strong>：明确个人信息处理遵循的法律依据，细化用户信息查询、更正、删除的申请流程及14个工作日响应时限。</li>
                ...
                <ul class="full-modal-list">
                    <li>细化账号注销流程：明确用户可通过官方客服申请注销，工作室在14个工作日内完成处理。</li>
                    <li>补充账号注销后信息处理规则：账号注销后14个工作日内删除用户个人信息，法律法规另有规定的除外。</li>
                ...
                <ul class="full-modal-list">
                    <li>1. 本次修订后的《用户协议》和《隐私政策》将于<strong>2026年1月1日</strong>正式生效。</li>
                    <li>2. 您可以通过我们的<a href="/agreement.html" target="_blank" class="full-modal-link">官方网站</a>、公告等渠道查阅修订后的完整协议文本。</li>
